  ...
  const handleAccept = async (user) => {
    ...
    try {
              ...
              values: [
                {
                  mapValue: {
                    fields: {
                      ...
                      IFSC: { stringValue: 'saabiq5555' }, // Store IFSC code in Accounts collection
                    },
                  },
                },
              ],
      ...
      const acceptEmailContent = `
        ...
        Congratulations! 🎉 We are thrilled to inform you that your account has been successfully created with us.

        Here are your account details for future reference:
      ...
      Your account is now ready for transactions! If you have any questions or need assistance, our support team is here to help. You can reach us at saabiqahamed23@gmail.com.
      ...
      ---
      **Tip**: Make sure to save this information for future reference. You can also access your account anytime through our online banking portal or mobile app.
      ...
      await axios.post('http://localhost:5000/send-email', {
        ...
        subject: ' Welcome to Saabiq Bank of India – Your Account Has Been Created Successfully!',
